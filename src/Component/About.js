...
export default function About() {
  ...
  const[mstyle,setMyStyle]=useState({
    color:'white',
...
const modeChange=()=>{
  ...
  return (
    <div className='container' style={mstyle}>
      ...
      <div className="accordion" id="accordionExample" style={mstyle}> 
...
<div className='container my-3'>
  <button  type="button" className="btn btn-primary" onClick={modeChange}>{btntext}</button>
